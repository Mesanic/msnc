...
- `.scratch/scope-rename/`: rename sextant, atlas and scalpel to Scope (01 is for `/msnc:implement`; 02 and 03 are human-in-the-loop). Decisions in `docs/decisions.md`
