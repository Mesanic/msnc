...
- [ ] Every command and option the README names exists in the plugin (the references test also covers README).
- [ ] The credits name all five upstreams, with repo links and licenses.
